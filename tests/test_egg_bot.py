...
class TestEggbotCore(unittest.TestCase):
    def test_globals(self):
        self.assertIsInstance(eggbot_core.logger, eggbot_core.logging.Logger)
        self.assertIsInstance(
            eggbot_core.eggbot_config, eggbot_core.core_entities.CoreConfig
        )

        self.assertIsInstance(
            eggbot_core.discord_client, eggbot_core.discord.client.Client
        )
